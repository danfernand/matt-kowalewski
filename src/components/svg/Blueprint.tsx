...
const Blueprint = () => {
  return (
    <svg version="1.1" x="0px" y="0px" viewBox="0 0 512 512">
      <path
        fill="#6FB0B6"
        d="M115.2,499.2V12.8H384v102.4c0,7.057,5.743,12.8,12.8,12.8h102.4v371.2H115.2z"
      />
      <path
        fill="#9A8984"
        d="M262.409,422.4V288c0-4.932-4.028-8.951-8.977-8.951H199.68c-4.949,0-8.977,4.019-8.977,8.951v134.4 H115.2V189.585L226.56,78.217l182.903,182.912H360.96V422.4H262.409z"
      />
      <rect x="12.8" y="12.8" fill="#538489" width="102.4" height="486.4" />
      <rect x="190.737" y="279.031" fill="#FEDEA1" width="71.646" height="143.369" />
      <polygon fill="#C5DFE2" points="384,128 384,7.492 504.491,128 " />
      <path
        fill="#000000"
        d="M402.099,7.501C397.303,2.697,390.793,0,384,0H25.6C11.46,0,0,11.46,0,25.6v460.8
