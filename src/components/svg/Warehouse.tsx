...
const Warehouse = () => {
  return (
    ...
    >
      <rect x="89.6" y="211.2" fill="#FEDEA1" width="332.8" height="76.8" />
      <path
        fill="#9A8984"
        d="M422.4,441.591v-217.6c0-7.057-5.743-12.8-12.8-12.8H102.4c-7.057,0-12.8,5.743-12.8,12.8v217.6H38.4
	V162.014L256,70.4l217.6,91.614v279.578H422.4z"
      />
      <rect x="89.6" y="288" fill="#FEEBC7" width="332.8" height="76.8" />
      <rect x="89.6" y="364.8" fill="#FEDEA1" width="332.8" height="76.8" />
      <path
        fill="#000000"
        d="M17.766,184.601l7.834-3.302v247.492H12.8c-7.074,0-12.8,5.726-12.8,12.8s5.726,12.8,12.8,12.8h486.4
